...
//   s3.upload({
//     Bucket: process.env.AWS_S3_BUCKETNAME as string,
//     Key: `accounts/${destFileName}`,
//     Body: file,
//     ContentType: contentType
//   }).send(callback);
// };

// export const deleteRecipeImageInS3 = (destFileName: string) => {
//   s3.deleteObject({
//     Bucket: process.env.AWS_S3_BUCKETNAME as string,
//     Key: `recipes/${destFileName}`
//   }).send();
// };

// export const deleteAccountImageInS3 = (destFileName: string) => {
//   s3.deleteObject({
//     Bucket: process.env.AWS_S3_BUCKETNAME as string,
//     Key: `accounts/${destFileName}`
//   }).send();
